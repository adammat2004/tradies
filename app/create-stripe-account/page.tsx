  ...
  return (
    <div className="container">
      <div className="banner">
        <h2>TRADEEZ LIMITED</h2>
      </div>
      <div className="content">
        {!connectedAccountId && <h2>Get ready for take off</h2>}
        {!connectedAccountId && <p>TRADEEZ LIMITED is the world's leading air travel platform: join our team of pilots to help people travel faster.</p>}
