...
const RecommendedListingCard: React.FC<ListingCardProps> = ({
    data,
}) => {
        ...
        <div onClick={() => router.push(`/listings/${id}`)} className="col-span-1 cursor-pointer group">
            <div className="flex flex-col gap-2 w-full">
                <div className="aspect-square w-full relative overflow-hidden rounded-xl">
                    ...
                    <div className="absolute top-3 right-3 text-rose-500 bg-white rounded-full px-3 py-1 text-xs font-semibold">
